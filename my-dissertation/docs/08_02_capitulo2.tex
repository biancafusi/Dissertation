...
\begin{figure}[ht]
	...
	\begin{center}
		\resizebox{10.5cm}{!}{\includegraphics{docs/figuras/mapalbacorr.png}}		
	\end{center}
	...
	\label{mapalocal}
	\FONTE{\citeonline{lba/06}.} % fonte consultada (Quando for produção do próprio autor não incluir a fonte.)
\end{figure}
...
\begin{figure}[ht]
	...
	\vspace{6mm}	% acrescentar o espaçamento vertical apropriado entre o título e a borda superior da figura
	\begin{center}
		\resizebox{11.5cm}{!}{\includegraphics{docs/figuras/rondonia.pdf}}		
	\end{center}
	...
	\label{rondonia}
	\FONTE{\citeonline{iag/05}.}	% fonte consultada (Quando for produção do próprio autor não incluir a fonte.)
\end{figure}
...
\begin{figure}[ht]
	...
	\vspace{6mm}	% acrescentar o espaçamento vertical apropriado entre o título e a borda superior da figura
	\begin{center}
		\resizebox{14cm}{!}{\includegraphics{docs/figuras/torredesenho.pdf}}		
	\end{center}
	\vspace{2mm}	% acrescentar o espaçamento vertical apropriado entre a borda inferior da figura e a legenda ou a fonte quando não há legenda (o valor pode ser negativo para subir)
	\legenda{}	% legenda - para deixar sem legenda usar comando \legenda{} (nunca deve-se comentar o comando \legenda)
	\label{torre}
	\FONTE{\citeonline{edtese/99}}. 	% fonte consultada (Quando for produção do próprio autor não incluir a fonte.)
\end{figure}
...
\begin{figure}[ht]
	...
	\vspace{6mm}	% acrescentar o espaçamento vertical apropriado entre o título e a borda superior da figura
	\begin{center}
		\resizebox{10.5cm}{!}{\includegraphics{docs/figuras/2torres.pdf}}		
	\end{center}
	\vspace{2mm}	% acrescentar o espaçamento vertical apropriado entre a borda inferior da figura e a legenda ou a fonte quando não há legenda (o valor pode ser negativo para subir)
