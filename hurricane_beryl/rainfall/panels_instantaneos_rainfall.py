...
# Experimentos selecionados (original)
#data_to_be_plotted = ['GPM-IMERG', 'GSMaP', 'CP-OFF', 'CP-ON', 'CP-D050', 'CP-GFS']
# to the master presentation:
data_to_be_plotted = ['GPM-IMERG', 'CP-OFF', 'CP-ON', 'CP-D050']
...
fig, axes = plt.subplots(nrows=4, ncols=3, figsize=(10, 15), subplot_kw={'projection': ccrs.PlateCarree()}) # to my presentation
...
# Salvar a figura
plt.savefig('/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/rainfall_analysis/paineis_chuva_instantanea_and_bias/newest/painel_instantaneous_rainfall_selected_with_stats_FINAL.png', dpi=300, bbox_inches='tight')
plt.close()
