...
if initial_day == '2024-07-01T00':
    ...
    if label_data == 'ERA5':
        ...
        name_file_prec = run_folder+'beryl_cporg0_gustf0_sub3d0_GFdef_ERA5_x1.655362/2024070100/diag/all_diag_dc.2024-07-01_00.00.00.nc'
        
    elif label_data == 'CP-1H':
        name_file_prec = run_folder+'beryl_cporg1_gustf1_sub3d0_TCP1H_ERA5_x1.655362/2024070100/diag/all_diag_dc.2024-07-01_00.00.00.nc'

    elif label_data == 'CP-3H':
        name_file_prec = run_folder+'beryl_cporg1_gustf1_sub3d0_TCP3H_ERA5_x1.655362/2024070100/diag/all_diag_dc.2024-07-01_00.00.00.nc'

    elif label_data == 'CP-6H':
        name_file_prec = run_folder+'beryl_cporg1_gustf1_sub3d0_TCP30MN_ERA5_x1.655362/2024070100/diag/all_diag_dc.2024-07-01_00.00.00.nc'

    elif label_data == 'CP-D025':
        name_file_prec = run_folder+'beryl_cporg1_gustf1_sub3d0_DOW025_ERA5_x1.655362/2024070100/diag/all_diag_dc.2024-07-01_00.00.00.nc'

    elif label_data == 'CP-D050':
        name_file_prec = run_folder+'beryl_cporg1_gustf1_sub3d0_DOW050_ERA5_x1.655362/2024070100/diag/all_diag_dc.2024-07-01_00.00.00.nc'

    elif label_data == 'CPSS-ON':
        name_file_prec = run_folder+'beryl_cporg1_gustf2_sub3d0_GFdef_ERA5_x1.655362/2024070100/diag/all_diag_dc.2024-07-01_00.00.00.nc'
...
######################################################## SAVING CONFIGS ########################################################
title = f'Accumulated Precipitation of {label_data} between {initial_day} and {final_day}' 
fig_name = f'Accumulated_Precipitation{label_data}_{initial_day}_{final_day}'
where_to_save = '/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/plots_accumulated/single_march_10/'