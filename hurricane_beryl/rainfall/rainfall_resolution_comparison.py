...
data_to_be_plotted = ['GPM-IMERG', 'CP-OFF', 'CP-30km', 'CP-15km']
...
fig, axes = plt.subplots(nrows=4, ncols=3, figsize=(10, 15), subplot_kw={'projection': ccrs.PlateCarree()})
...
# Salvar a figura
plt.savefig('painel_resolution_rainfall_FINAL_PRESENTATION.png', dpi=300, bbox_inches='tight')
plt.close()
