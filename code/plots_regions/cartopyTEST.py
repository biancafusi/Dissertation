...
def cartopy_amazon(data, lats, lons, lim_min='', lim_max='', num_div='', plotname='', figname='', out='', cbar=True, unit='mm/h'):
    ...
    largura_fig = 1.3 #polegadas
    altura_fig = 1.6 #polegadas
    ...
    if cbar:
        CB = fig.colorbar(filled, orientation='vertical', shrink=0.45, aspect=20)
        ...
        #CB.ax.xaxis.set_major_formatter(FuncFormatter(lambda x, pos: f'{int(x)}'))
