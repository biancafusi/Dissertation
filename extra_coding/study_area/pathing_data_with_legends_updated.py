...
from namelist_for_time_series_updated import *
...
# Model data:
if different_day == 'ON':
    time_new = NOAA.time.sel(time=slice(new_day,final_time))
...
ax.set_extent([-102, -50, 8, 40], crs=ccrs.PlateCarree()) # One could change this to get the study-area lat/lon region
