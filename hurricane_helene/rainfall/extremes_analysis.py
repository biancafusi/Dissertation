...
# Bins logarítmicos
thresholds = np.logspace(np.log10(0.1), np.log10(550), num=60)
...
fig, axes = plt.subplots(nrows=2, ncols=1, figsize=(7, 14))
...
plt.tight_layout()
output_path = '/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/helene_rainfall_statistics/helene_PDF_CDF/85_percentile_CDF_FINAL.png'
