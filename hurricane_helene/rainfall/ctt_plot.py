...
# # Caminhos
# folder_of_data = '/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/helene_rainfall_statistics/ctt_native/'
# # preciso colocar as files .nc da chuva na resolução nativa desses dados.

# where_save_figure = '/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/helene_rainfall_statistics/ctt_plots/'
...
# experiments_to_plot = ['GPM-MERGIR', 'CP-OFF', 'CP-ON', 'CP-1HD050', 'CP-25']


# # for label in experiments_to_plot:
# #     for initial_day in days_selected.values():
# #         ds = xr.open_dataset(folder_of_data + f'{label}_hourly.nc').sel(time=initial_day,method='nearest')
# #         variable = ds['ctt']
...
#         ds = xr.open_dataset(folder_of_data + f'{experiment_file}_hourly.nc').sel(time=initial_day,method='nearest')
#         ctt = ds['ctt']
#         lonW, lonE, latS, latN = extents[col_idx]
...
# # 5. Salvar figura
# # -----------------------------
# plt.savefig('/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/helene_rainfall_statistics/ctt_plots/painel_ctt_selected_experiments_FINAL.png', dpi=300, bbox_inches='tight')
# plt.close()
...
# Experimentos selecionados para o painel
experiments_to_plot = ['GPM-MERGIR', 'CP-OFF', 'CP-30km', 'CP-15km']
...
for row_idx, experiment_file in enumerate(experiments_to_plot):
    for col_idx, (day_name, initial_day) in enumerate(days_selected.items()):
        ...
        ds = xr.open_dataset('/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/helene_rainfall_statistics/ctt_native/' 
...
# 5. Salvar figura
# -----------------------------
plt.savefig('Panel_ctt_native_resolution_FINAL.png', dpi=300, bbox_inches='tight')
plt.close()
