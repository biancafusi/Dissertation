...
plt.tight_layout()
# output_path = '/mnt/beegfs/bianca.fusinato/monan/MASTERS_RESULTS/helene_rainfall_statistics/helene_PDF_CDF/painel_pdf_cdf_FINAL.png'
output_path = 'painel_pdf_cdf_PRESENTATION.png'
